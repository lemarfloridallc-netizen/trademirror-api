...
BEHAVIORAL_SIGNALS = {
    ...
    "BS003": {
        "name": "Respects Risk Management.",
        "spanish_name": "Respeta el Risk Management.",
    ...
    "BS004": {
        "name": "Moves Risk Management. Emotionally",
        "spanish_name": "Mueve el Risk Management. por Emoción",
        "description": "The trader changes the Risk Management. because of fear, hope, or pressure.",
        "positive": False,
        "dimensions": ["discipline_score", "risk_management_score", "psychology_score"],
    },
    "BS005": {
